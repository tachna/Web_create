...
app.put('/editmypage',function(요청,응답){
    ...
    { $set : {id: 요청.body.identi,/* pw: 요청.body.password,*/ born: 요청.body.born, sex: 요청.body.sex, address: 요청.body.address, number: 요청.body.number, email: 요청.body.email, email_b : 요청.body.edomain, smsyes_lbl:요청.body.smsyes_lbl, emailyes_lbl:요청.body.emailyes_lbl}},function(에러, 결과){
        console.log('수정완료')
        응답.redirect('/newpage')
    })
});
